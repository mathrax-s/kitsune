...
const mtouch_button_t mtouch_button_init[6] =
{
...
static mtouch_button_t mtouch_button[6];
...
__builtin_memcpy(mtouch_button,mtouch_button_init,sizeof(mtouch_button_init));
...
if ((button->counter) <= (mtouch_button_statecounter_t)((mtouch_button_baselinecounter_t)16)/2)
{
...
(button->counter)++;
if ((button->counter) >= (mtouch_button_statecounter_t)((mtouch_button_baselinecounter_t)16))
{
...
{
(button->counter)++;
if ((button->counter) > (mtouch_button_statecounter_t)((mtouch_button_statecounter_t)64))
{
button->counter = (mtouch_button_statecounter_t)0;
MTOUCH_Button_Initialize(button->name);
}
...
if ((button->baseline_count) == ((mtouch_button_baselinecounter_t)64))
{
button->baseline_count = (mtouch_button_baselinecounter_t)0;
Button_Baseline_Update(button);
}
...
if ((button->counter) >= ((mtouch_button_statecounter_t)100))
{
MTOUCH_Button_Initialize(button->name);
...
button->state = MTOUCH_BUTTON_STATE_notPressed;
button->counter = (mtouch_button_statecounter_t)0;
button->baseline_count = (mtouch_button_baselinecounter_t)((65535U))-((mtouch_button_baselinecounter_t)1024);
callback_notPressed(button->name);
}
}
...
{
if(name < 6)
return (bool)((mtouch_button[name].state == MTOUCH_BUTTON_STATE_pressed) ? 1 : 0);
else
return 0;
}
...
{
if(name < 6)
return (bool)((mtouch_button[name].state == MTOUCH_BUTTON_STATE_initializing) ? 0 : 1);
else
return 0;
}
